...
$serviceSchemas = [
  SchemaEnforcement::generateService([
    '@id' => canonical('/services/schema-optimizer/').'#service',
    'name' => 'Schema Optimizer & Reverse Engineer',
    'description' => 'Optimize structured data for AI visibility. Our Schema Optimizer focuses on schema coverage audits, reverse-engineering competitors, and consensus checks through Entity Graph Builder and Schema Consensus Layer technologies.',
