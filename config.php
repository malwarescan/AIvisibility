...
$STATES = [
  'new-york' => ['name'=>'New York','abbr'=>'NY','cities'=>['New York','Buffalo','Rochester','Syracuse','Albany']],
  'california'=>['name'=>'California','abbr'=>'CA','cities'=>['Los Angeles','San Francisco','San Diego','San Jose','Oakland','Sacramento']],
  'texas' => ['name'=>'Texas','abbr'=>'TX','cities'=>['Austin','Dallas','Houston','San Antonio','Fort Worth','El Paso']],
  'florida'=>['name'=>'Florida','abbr'=>'FL','cities'=>['Miami','Orlando','Tampa','Jacksonville','St. Petersburg','Hialeah']],
  'washington'=>['name'=>'Washington','abbr'=>'WA','cities'=>['Seattle','Bellevue','Spokane','Tacoma','Vancouver','Everett']],
  'illinois'=>['name'=>'Illinois','abbr'=>'IL','cities'=>['Chicago','Aurora','Rockford','Joliet','Naperville','Springfield']],
  'massachusetts'=>['name'=>'Massachusetts','abbr'=>'MA','cities'=>['Boston','Worcester','Springfield','Cambridge','Lowell','Brockton']],
  'georgia'=>['name'=>'Georgia','abbr'=>'GA','cities'=>['Atlanta','Augusta','Columbus','Savannah','Athens','Sandy Springs']],
  'north-carolina'=>['name'=>'North Carolina','abbr'=>'NC','cities'=>['Charlotte','Raleigh','Greensboro','Durham','Winston-Salem','Fayetteville']],
  'michigan'=>['name'=>'Michigan','abbr'=>'MI','cities'=>['Detroit','Grand Rapids','Warren','Sterling Heights','Lansing','Ann Arbor']],
  'virginia'=>['name'=>'Virginia','abbr'=>'VA','cities'=>['Virginia Beach','Norfolk','Chesapeake','Richmond','Newport News','Alexandria']],
  'tennessee'=>['name'=>'Tennessee','abbr'=>'TN','cities'=>['Nashville','Memphis','Knoxville','Chattanooga','Clarksville','Murfreesboro']],
  'arizona'=>['name'=>'Arizona','abbr'=>'AZ','cities'=>['Phoenix','Tucson','Mesa','Chandler','Scottsdale','Glendale']],
  'colorado'=>['name'=>'Colorado','abbr'=>'CO','cities'=>['Denver','Colorado Springs','Aurora','Fort Collins','Lakewood','Thornton']],
  'oregon'=>['name'=>'Oregon','abbr'=>'OR','cities'=>['Portland','Salem','Eugene','Gresham','Bend','Hillsboro']],
];
